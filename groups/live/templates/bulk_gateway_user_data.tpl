...
#Copy crontabs
cp -p /tmp/chips-service-admin/scripts/bulk-outputs/crontab-bulk-live /var/spool/cron/bulk-live
chown bulk-live:bulk-live /var/spool/cron/bulk-live
cp -p /tmp/chips-service-admin/scripts/bulk-outputs/crontab-gateway-live /var/spool/cron/gateway
...
sh -c 'echo "export NICKNAME=bulk-gateway" > /etc/profile.d/prompt.sh'
