...
data "vault_generic_secret" "bulk_gateway_e5_ssh_key_data" {
  path = "applications/${var.aws_account}-${var.aws_region}/${var.bulk_gateway_application}/bulk-gw-lx/e5-ssh"
}

data "vault_generic_secret" "bulk_gateway_gateway_ssh_key_data" {
  path = "applications/${var.aws_account}-${var.aws_region}/${var.bulk_gateway_application}/bulk-gw-lx/gateway-ssh"
}
