locals {
  ...
  bulk_gateway_bulk_live_dot_aws_data = data.vault_generic_secret.bulk_gateway_bulk_live_dot_aws_data.data
  bulk_gateway_gateway_dot_aws_data = data.vault_generic_secret.bulk_gateway_gateway_dot_aws_data.data
